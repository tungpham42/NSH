<nav>
	<ul id="nav_buttons">
		...
		-->
		<li><a id="wiki_link" class="nav_button button keep" href="http://nhipsinhhoc.vn/wiki/" target="_blank" title="Wiki"><i class="social-wikipedia"></i></a></li>
		<li><a id="blog_link" class="nav_button button keep" href="http://nhipsinhhoc.vn/blog/" target="_blank" title="Blog"><i class="icon-book-open"></i></a></li>
